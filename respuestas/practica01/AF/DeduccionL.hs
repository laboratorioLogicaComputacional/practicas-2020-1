...
esAxL2 :: PLI -> Bool
esAxL2 (Oimp (Oimp alpha1 (Oimp betha1 gamma1)) (Oimp (Oimp alpha2 betha2) (Oimp alpha3 gamma2))) = alpha1 == alpha2 && alpha2 == alpha3 && betha1 == betha2 && gamma1 == gamma2 
esAxL2 phi = False

-- Función que nos dice si una formula de PLI cumple el Axioma 3
esAxL3 :: PLI -> Bool
esAxL3 (Oimp (Oimp (Oimp (alpha1) Bot) (Oimp (betha1) Bot)) (Oimp (betha2) (alpha2))) = alpha1 == alpha2 && betha1 == betha2 
esAxL3 phi = False
...
esModusPonens (alpha1, (Oimp alpha2 betha1), betha2) = alpha1 == alpha2 && betha1 == betha2
esModusPonens (phi, chi, psi) = False 
...
checkPaso lprem lpp p = case p of
  (n, (phi, Prem)) -> elem phi lprem 
  (n, (phi, Ax)) -> esAxiomaDeL phi 
